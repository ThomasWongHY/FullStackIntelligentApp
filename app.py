...
def main():
    with st.form("road_traffic_severity_form"):
        ...
        fast_track = st.radio("Funding:",options=options_fast_track, index=None)
        coop = st.radio("Funding:",options=options_coop, index=None)
        residency = st.radio("Residency:",options=options_residency, index=None)
